...
/**
 * print_class - Prints class of an ELF header file
...
/**
 * print_data – Print the content of an ELF header.
 * @e_ident: an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_osabi - Print the OS/ABI of an ELF header file.
 * @e_ident: an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * print_abi - Prints ABI version of an ELF header file.
...
/**
 * print_entry – Print the entry point to an ELF header file.
